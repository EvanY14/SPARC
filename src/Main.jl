...
edl_params = EDLParams(mass, drag_coefficient, lift_coefficient, area, μ, R, mpc, 0.0, (LatLonAlt, t) -> atmospheric_density(LatLonAlt, t, gram_atmosphere, false), 0.0, SVector{3, Float64}(zeros(3)), target_states, optimization_states, edl_cache)
