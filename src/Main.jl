...
gram_atmosphere = GramAtmosphere("GRAMpy/", "GRAM_Data", true, "mars", DateTime(2024, 1, 1, 0, 0, 0.0))
edl_cache = EDLCache()
edl_params = EDLParams(mass, drag_coefficient, lift_coefficient, area, μ, R, β, 0.0, target_altitude, integrator -> atmospheric_density(integrator, gram_atmosphere, true), 0.0, edl_cache)
